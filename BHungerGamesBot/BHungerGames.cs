    ...
    public class BHungerGames
    {
        ...
        static BHungerGames()
        {
            Scenarios = new[]
            {
                ...
                new Scenario("{@P1} disconnected in the middle of Kaleido heroic fight... RIP", 1),
                ...
                new Scenario("{@P1} is smart, and decides to hide up in the trees. \n Could this be it? is it? YES! - its time to drop the blubber suit and turn into a buuutiful butterfly! Unfortunately, fairytales are not real, and {@P1} didnt fly, but fell to his death ", 1),
                ...
                new Scenario("As {@P1} runs through a dungeon, {@P1} spies a Mimeido! But he didn't watch all his items and Mimeido ate his foot pretending to be a sock. ", 1),
                ...
                new Scenario("{@P1} pulls a Leeroy Jenkins and rushes into z4d4. We all know how that turns out. ", 1),
                ...
                new Scenario("{@P1} Died of exhaustion trying to find the Bobodom schematic for 6 straight weeks. ", 1),
                ...
                new Scenario("{@P1} attacked Rolace! Rolace deflected {@P1}'s attack right into {@P1} and killed him. ", 1),
                ...
                new Scenario("{@P1} fell in a pit of despair. Life's hard.", 1),
                ...
                new Scenario("{@P1} mentioned @Tarri in discord while she was sleeping and was found dead later that day.",1),
                ...
                new Scenario("Cuerade sniped {@P2} out of a tree he was hiding in, {@P1} broke the fall and died instead of {@P2}.", 2),
                ...
                new Scenario("{@P1} thought he would be funny and light a Warty's fart on fire. {@P1} was incinerated.", 1)
            };
        }
